document.addEventListener('DOMContentLoaded', () => {
    ...
    recipeForm.addEventListener('submit', (event) => {
        ...
        const data = {
            title,
            ingredients: JSON.stringify(ingredients), // Convertir en JSON pour envoyer un tableau
            preparations: JSON.stringify(preparations), // Convertir en JSON pour envoyer un tableau
        };
